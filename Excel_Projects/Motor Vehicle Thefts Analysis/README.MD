...
- 🖼️ [Motor_Vehicle_ Thefts_dashboard](./Motor_Vehicle_Thefts_dashboard.png) → Preview image of the dashboard  
- 📈 [Motor_Vehicle_ Thefts_dashboard](./Motor_Vehicle_Thefts_dashboard.xlsx) → Interactive Excel dashboard (with slicers for year & month)  
